...
namespace HOTELNAPOLI.Migrations
{
    ...
    [Migration("20240307153147_Prenotazioni")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HOTELNAPOLI.Models.Prenotazioni", b =>
                {
                    b.HasOne("HOTELNAPOLI.Models.Camere", "IDCamera")
                        .WithMany()
                        .HasForeignKey("IDCameraID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HOTELNAPOLI.Models.Clienti", "IDCliente")
                        .WithMany()
                        .HasForeignKey("IDClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HOTELNAPOLI.Models.Pensioni", "IDPensione")
                        .WithMany()
